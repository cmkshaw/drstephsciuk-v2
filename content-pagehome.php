<?php
/**
 * The template used for displaying page content for homepage
 *
 * @package WordPress
...
<article id="post-<?php the_ID(); ?>" <?php post_class(); ?>>
	...
	?>
<header class="entry-header"><h1 class="entry-title">Hello and welcome.</h1><h2> I am a Naturopathic Doctor working in beautiful Barrie, Ontario.</h2></header>
